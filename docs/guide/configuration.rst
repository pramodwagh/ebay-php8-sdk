...
This guide describes the service configuration options. These options can be provided in a service constructor or to the ``PWCode\eBaySDK\Sdk`` class.
...
.. code-block:: php
    ...
    use PWCode\eBaySDK\Shopping\Services\ShoppingService;
...
.. code-block:: php
    ...
    use PWCode\eBaySDK\Trading\Types;
    use PWCode\eBaySDK\Trading\Services;
...
.. code-block:: php
    ...
    use PWCode\eBaySDK\Browse\Services\BrowseService;
...
:Type: ``array|PWCode\eBaySDK\Credentials\CredentialsInterface|callable``
...
You can also pass an instance of the ``PWCode\eBaySDK\Credentials\CredentialsInterface`` interface.
