...
.. code-block:: php
    ...
    <?php
    use \PWCode\eBaySDK\Browse\Types;

    $request = new Types\GetItemRestRequest();

    /**
     * $response will be of the type PWCode\eBaySDK\Browse\Types\GetItemRestResponse
     */
...
The SDK provides some support for generating the OAuth tokens needed by the RESTful services. This is provided via the ``\PWCode\eBaySDK\OAuth\Services\OAuthService`` class.


.. code-block:: php

    use \PWCode\eBaySDK\OAuth\Services;
    use \PWCode\eBaySDK\OAuth\Types;
