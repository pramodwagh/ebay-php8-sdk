...
2. Install the SDK.
   ...
   ::
       ...
       php composer.phar require PWCode/ebay-sdk-php
...
Each release of the SDK comes with a `phar <http://php.net/manual/en/book.phar.php>`_ archive. This contains all the classes and dependencies you need to run the SDK. You can download the phar from the `SDK releases <https://github.com/daviPWCodeadler/ebay-sdk-php/releases>`_. Using the phar in your project is as simple as including it in your scripts.
...
You can download a zip archive from the `SDK releases <https://github.com/daviPWCodeadler/ebay-sdk-php/releases>`_ which contains all the classes and dependencies you need to run the SDK. Unzip the archive into a directory of your choice and include the provided autoloader in your project's code.
