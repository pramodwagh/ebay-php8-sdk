...
Run the `requirements_check.php <https://github.com/daviPWCodeadler/ebay-sdk-php/blob/master/requirements_check.php>`_ file in the SDK to check that your system meets the minimum requirements. It can be run from the command line or a web browser and will report which checks your system passes and fails.
