...
use PWCode\eBaySDK\ProductMetadata\Types\TypeSpecificInformation;
...
class TypeSpecificInformationTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\ProductMetadata\Types\TypeSpecificInformation', $this->obj);
    }
