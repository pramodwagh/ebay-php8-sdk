...
use PWCode\eBaySDK\BusinessPoliciesManagement\Types\FreightShipping;
...
class FreightShippingTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\BusinessPoliciesManagement\Types\FreightShipping', $this->obj);
    }
