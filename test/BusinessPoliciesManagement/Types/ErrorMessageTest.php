...
use PWCode\eBaySDK\BusinessPoliciesManagement\Types\ErrorMessage;
...
class ErrorMessageTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\BusinessPoliciesManagement\Types\ErrorMessage', $this->obj);
    }
