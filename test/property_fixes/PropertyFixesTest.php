...
class PropertyFixesTest extends \PHPUnit_Framework_TestCase
{
     ...
     * Example of correct property names returned in the API https://github.com/daviPWCodeadler/ebay-sdk-php/issues/108
     */
    public function testCancelSummary()
    {
        ...
        $this->assertInstanceOf('\PWCode\eBaySDK\Types\RepeatableType', $obj->lineItems);
    }
     ...
     * Example of correct property names returned in the API https://github.com/daviPWCodeadler/ebay-sdk-php/issues/105
     */
    ...
    public function testDeliveryCost()
    {
        ...
        $this->assertInstanceOf('\PWCode\eBaySDK\Fulfillment\Types\Amount', $obj->discountAmount);
    }
    ...
    public function testPriceDiscount()
    {
        ...
        $this->assertInstanceOf('\PWCode\eBaySDK\Fulfillment\Types\Amount', $obj->priceDiscount);
    }

    public function testPriceDiscountSubtotalDoesNotExist()
    {
        $this->setExpectedException('\PWCode\eBaySDK\Exceptions\UnknownPropertyException', 'Unknown property');
     ...
     * Example of correct property names returned in the API https://github.com/daviPWCodeadler/ebay-sdk-php/issues/107
     */
     ...
     * Issue: https://github.com/daviPWCodeadler/ebay-sdk-php/issues/133
     * PR: https://github.com/daviPWCodeadler/ebay-sdk-php/pull/134
     */
     ...
     *
     * https://github.com/daviPWCodeadler/ebay-sdk-php/issues/154
     */
