...
use PWCode\eBaySDK\Test\Mocks\AmountClass;
...
class ConstructTest extends \PHPUnit_Framework_TestCase
{
    public function testSettingPropertiesViaCtor()
    {
        ...
        $this->assertInstanceOf('\PWCode\eBaySDK\Types\RepeatableType', $obj->strings);

        $this->assertEquals(2, count($obj->integers));
        $this->assertEquals(111, $obj->integers[0]);
        $this->assertEquals(222, $obj->integers[1]);
        $this->assertInstanceOf('\PWCode\eBaySDK\Types\RepeatableType', $obj->integers);

        $this->assertEquals(543.21, $obj->AmountClass->value);
        $this->assertEquals('one', $obj->AmountClass->AttributeOne);
        $this->assertInstanceOf('\PWCode\eBaySDK\Test\Mocks\AmountClass', $obj->AmountClass);
        ...
        $this->assertInstanceOf('\PWCode\eBaySDK\Test\Mocks\SimpleClass', $obj->SimpleClass);
        ...
        $this->assertInstanceOf('\PWCode\eBaySDK\Types\RepeatableType', $obj->simpleClasses);
        ...
        $this->assertInstanceOf('\PWCode\eBaySDK\Types\RepeatableType', $obj->anyTypes);
    }

    public function testSettingInvalidPropertyViaCtor()
    {
        $this->setExpectedException('\PWCode\eBaySDK\Exceptions\UnknownPropertyException', 'Unknown property bar');
    ...
    {
        $this->setExpectedException('\PWCode\eBaySDK\Exceptions\InvalidPropertyTypeException', 'Invalid property type provided for string. Expected string but got integer');
