...
use PWCode\eBaySDK\Test\Mocks\SimpleClass;
use PWCode\eBaySDK\Test\Mocks\Base64BinaryType;
use PWCode\eBaySDK\Test\Mocks\BooleanType;
use PWCode\eBaySDK\Test\Mocks\DecimalType;
use PWCode\eBaySDK\Test\Mocks\DoubleType;
use PWCode\eBaySDK\Test\Mocks\IntegerType;
use PWCode\eBaySDK\Test\Mocks\StringType;
use PWCode\eBaySDK\Test\Mocks\TokenType;
use PWCode\eBaySDK\Test\Mocks\URIType;
...
class SimpleClassTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\Test\Mocks\SimpleClass', $this->obj);
    }
    ...
    public function testGettingSettingProperties()
    {
        ...
        $this->assertInstanceOf('\PWCode\eBaySDK\Test\Mocks\SimpleClass', $this->obj->SimpleClass);

        $this->assertEquals(0, count($this->obj->strings));
        $this->assertInstanceOf('\PWCode\eBaySDK\Types\RepeatableType', $this->obj->strings);
        ...
        $this->assertInstanceOf('\PWCode\eBaySDK\Types\RepeatableType', $this->obj->integers);
        ...
        $this->assertInstanceOf('\PWCode\eBaySDK\Types\RepeatableType', $this->obj->anyTypes);
        $this->obj->anyTypes[] = 1;
    ...
    {
        $this->setExpectedException('\PWCode\eBaySDK\Exceptions\UnknownPropertyException', 'Unknown property foo');
    ...
    {
        $this->setExpectedException('\PWCode\eBaySDK\Exceptions\InvalidPropertyTypeException', 'Invalid property type provided for integer. Expected integer but got string');
    ...
    {
        $this->setExpectedException('\PWCode\eBaySDK\Exceptions\InvalidPropertyTypeException', 'Invalid property type provided for integers. Expected integer but got string');
    ...
    {
        $this->setExpectedException('\PWCode\eBaySDK\Exceptions\InvalidPropertyTypeException', 'Invalid property type provided for integers. Expected PWCode\eBaySDK\Types\RepeatableType but got integer');
    ...
    public function testCanGetElementMeta()
    {
        ...
        $meta->phpType = 'PWCode\eBaySDK\Test\Mocks\SimpleClass';
