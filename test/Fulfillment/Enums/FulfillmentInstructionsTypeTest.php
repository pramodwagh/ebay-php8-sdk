...
use PWCode\eBaySDK\Fulfillment\Enums\FulfillmentInstructionsType;
...
class FulfillmentInstructionsTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\Fulfillment\Enums\FulfillmentInstructionsType', $this->obj);
    }
}
