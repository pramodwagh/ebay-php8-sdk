...
use PWCode\eBaySDK\MerchantData\Enums\CharitySellerStatusCodeType;
...
class CharitySellerStatusCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\MerchantData\Enums\CharitySellerStatusCodeType', $this->obj);
    }
}
