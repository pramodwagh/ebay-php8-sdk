...
use PWCode\eBaySDK\MerchantData\Enums\PaymentInstructionCodeType;
...
class PaymentInstructionCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\MerchantData\Enums\PaymentInstructionCodeType', $this->obj);
    }
}
