...
use PWCode\eBaySDK\MerchantData\Enums\SellerPaymentMethodCodeType;
...
class SellerPaymentMethodCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\MerchantData\Enums\SellerPaymentMethodCodeType', $this->obj);
    }
}
