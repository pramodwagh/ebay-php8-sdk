...
use PWCode\eBaySDK\MerchantData\Enums\RefundingSourceTypeCodeType;
...
class RefundingSourceTypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\MerchantData\Enums\RefundingSourceTypeCodeType', $this->obj);
    }
}
