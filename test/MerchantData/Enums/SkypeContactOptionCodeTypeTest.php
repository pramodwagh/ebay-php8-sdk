...
use PWCode\eBaySDK\MerchantData\Enums\SkypeContactOptionCodeType;
...
class SkypeContactOptionCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\MerchantData\Enums\SkypeContactOptionCodeType', $this->obj);
    }
}
