...
use PWCode\eBaySDK\MerchantData\Enums\TransactionPlatformCodeType;
...
class TransactionPlatformCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\MerchantData\Enums\TransactionPlatformCodeType', $this->obj);
    }
}
