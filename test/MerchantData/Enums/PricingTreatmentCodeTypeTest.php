...
use PWCode\eBaySDK\MerchantData\Enums\PricingTreatmentCodeType;
...
class PricingTreatmentCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\MerchantData\Enums\PricingTreatmentCodeType', $this->obj);
    }
}
