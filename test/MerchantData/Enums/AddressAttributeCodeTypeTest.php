...
use PWCode\eBaySDK\MerchantData\Enums\AddressAttributeCodeType;
...
class AddressAttributeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\MerchantData\Enums\AddressAttributeCodeType', $this->obj);
    }
}
