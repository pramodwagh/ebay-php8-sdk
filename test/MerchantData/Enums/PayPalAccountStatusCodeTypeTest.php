...
use PWCode\eBaySDK\MerchantData\Enums\PayPalAccountStatusCodeType;
...
class PayPalAccountStatusCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\MerchantData\Enums\PayPalAccountStatusCodeType', $this->obj);
    }
}
