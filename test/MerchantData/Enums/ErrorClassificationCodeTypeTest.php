...
use PWCode\eBaySDK\MerchantData\Enums\ErrorClassificationCodeType;
...
class ErrorClassificationCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\MerchantData\Enums\ErrorClassificationCodeType', $this->obj);
    }
}
