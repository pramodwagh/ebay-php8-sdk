...
use PWCode\eBaySDK\MerchantData\Enums\BuyerPaymentMethodCodeType;
...
class BuyerPaymentMethodCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\MerchantData\Enums\BuyerPaymentMethodCodeType', $this->obj);
    }
}
