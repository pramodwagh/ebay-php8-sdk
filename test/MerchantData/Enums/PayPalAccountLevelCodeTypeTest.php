...
use PWCode\eBaySDK\MerchantData\Enums\PayPalAccountLevelCodeType;
...
class PayPalAccountLevelCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\MerchantData\Enums\PayPalAccountLevelCodeType', $this->obj);
    }
}
