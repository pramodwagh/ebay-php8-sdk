...
use PWCode\eBaySDK\MerchantData\Enums\RefundSourceTypeCodeType;
...
class RefundSourceTypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\MerchantData\Enums\RefundSourceTypeCodeType', $this->obj);
    }
}
