...
use PWCode\eBaySDK\MerchantData\Enums\FeedbackRatingStarCodeType;
...
class FeedbackRatingStarCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\MerchantData\Enums\FeedbackRatingStarCodeType', $this->obj);
    }
}
