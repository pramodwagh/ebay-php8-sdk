...
use PWCode\eBaySDK\MerchantData\Enums\PaymentHoldReasonCodeType;
...
class PaymentHoldReasonCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\MerchantData\Enums\PaymentHoldReasonCodeType', $this->obj);
    }
}
