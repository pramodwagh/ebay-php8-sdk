...
use PWCode\eBaySDK\MerchantData\Enums\PictureUploadPolicyCodeType;
...
class PictureUploadPolicyCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\MerchantData\Enums\PictureUploadPolicyCodeType', $this->obj);
    }
}
