...
use PWCode\eBaySDK\MerchantData\Enums\ItemSpecificSourceCodeType;
...
class ItemSpecificSourceCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\MerchantData\Enums\ItemSpecificSourceCodeType', $this->obj);
    }
}
