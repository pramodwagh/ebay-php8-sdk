...
use PWCode\eBaySDK\MerchantData\Enums\PayPalAccountTypeCodeType;
...
class PayPalAccountTypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\MerchantData\Enums\PayPalAccountTypeCodeType', $this->obj);
    }
}
