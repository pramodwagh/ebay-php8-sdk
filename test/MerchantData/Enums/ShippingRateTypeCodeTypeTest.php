...
use PWCode\eBaySDK\MerchantData\Enums\ShippingRateTypeCodeType;
...
class ShippingRateTypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\MerchantData\Enums\ShippingRateTypeCodeType', $this->obj);
    }
}
