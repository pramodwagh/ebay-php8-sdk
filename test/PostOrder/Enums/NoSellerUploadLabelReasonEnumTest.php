...
use PWCode\eBaySDK\PostOrder\Enums\NoSellerUploadLabelReasonEnum;
...
class NoSellerUploadLabelReasonEnumTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\PostOrder\Enums\NoSellerUploadLabelReasonEnum', $this->obj);
    }
}
