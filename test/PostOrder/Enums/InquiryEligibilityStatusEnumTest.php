...
use PWCode\eBaySDK\PostOrder\Enums\InquiryEligibilityStatusEnum;
...
class InquiryEligibilityStatusEnumTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\PostOrder\Enums\InquiryEligibilityStatusEnum', $this->obj);
    }
}
