...
use PWCode\eBaySDK\PostOrder\Types\EscalateInquiryRestResponse;
...
class EscalateInquiryRestResponseTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\PostOrder\Types\EscalateInquiryRestResponse', $this->obj);
    }
