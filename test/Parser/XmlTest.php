<?php
namespace PWCode\eBaySDK\Parser\Test;
...
class XmlTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $xmlParser = new XmlParser('\PWCode\eBaySDK\Test\Mocks\ComplexClass');
        $xml = file_get_contents(__DIR__.'/../Mocks/Response.xml');
        $xml = preg_replace('/[\n\r]/', '', $xml);
        $xml = preg_replace('/>\s+/', '>', $xml);
        $obj = $xmlParser->parse($xml);

        $this->assertInstanceOf('\PWCode\eBaySDK\Test\Mocks\ComplexClass', $obj);
        ...
        $this->assertEquals('bar', $obj->strings[1]);
        $this->assertInstanceOf('\PWCode\eBaySDK\Test\Mocks\SimpleClass', $obj->simpleClasses[0]);
        $this->assertEquals(888, $obj->simpleClasses[0]->integer);
        $this->assertInstanceOf('\PWCode\eBaySDK\Test\Mocks\SimpleClass', $obj->simpleClasses[1]);
