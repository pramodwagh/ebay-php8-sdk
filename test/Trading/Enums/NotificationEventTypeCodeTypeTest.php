...
use PWCode\eBaySDK\Trading\Enums\NotificationEventTypeCodeType;
...
class NotificationEventTypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\Trading\Enums\NotificationEventTypeCodeType', $this->obj);
    }
}
