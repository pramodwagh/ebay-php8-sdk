...
use PWCode\eBaySDK\Trading\Enums\VeROReportPacketStatusCodeType;
...
class VeROReportPacketStatusCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\Trading\Enums\VeROReportPacketStatusCodeType', $this->obj);
    }
}
