...
use PWCode\eBaySDK\Trading\Enums\ShippingTrackingEventCodeType;
...
class ShippingTrackingEventCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\Trading\Enums\ShippingTrackingEventCodeType', $this->obj);
    }
}
