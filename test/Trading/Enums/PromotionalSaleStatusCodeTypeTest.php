...
use PWCode\eBaySDK\Trading\Enums\PromotionalSaleStatusCodeType;
...
class PromotionalSaleStatusCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\Trading\Enums\PromotionalSaleStatusCodeType', $this->obj);
    }
}
