...
use PWCode\eBaySDK\Trading\Enums\PolicyComplianceStatusCodeType;
...
class PolicyComplianceStatusCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\Trading\Enums\PolicyComplianceStatusCodeType', $this->obj);
    }
}
