...
use PWCode\eBaySDK\Trading\Enums\ApplicationDeviceTypeCodeType;
...
class ApplicationDeviceTypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\Trading\Enums\ApplicationDeviceTypeCodeType', $this->obj);
    }
}
