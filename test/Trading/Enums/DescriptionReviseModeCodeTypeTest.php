...
use PWCode\eBaySDK\Trading\Enums\DescriptionReviseModeCodeType;
...
class DescriptionReviseModeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\Trading\Enums\DescriptionReviseModeCodeType', $this->obj);
    }
}
