...
use PWCode\eBaySDK\Trading\Enums\BuyerPaymentInstrumentCodeType;
...
class BuyerPaymentInstrumentCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\Trading\Enums\BuyerPaymentInstrumentCodeType', $this->obj);
    }
}
