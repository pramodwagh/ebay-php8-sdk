...
use PWCode\eBaySDK\Trading\Enums\NotificationEventStateCodeType;
...
class NotificationEventStateCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\Trading\Enums\NotificationEventStateCodeType', $this->obj);
    }
}
