...
use PWCode\eBaySDK\Trading\Enums\BuyerProtectionSourceCodeType;
...
class BuyerProtectionSourceCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\Trading\Enums\BuyerProtectionSourceCodeType', $this->obj);
    }
}
