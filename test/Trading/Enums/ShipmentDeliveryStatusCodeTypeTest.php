...
use PWCode\eBaySDK\Trading\Enums\ShipmentDeliveryStatusCodeType;
...
class ShipmentDeliveryStatusCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\Trading\Enums\ShipmentDeliveryStatusCodeType', $this->obj);
    }
}
