...
use PWCode\eBaySDK\Trading\Enums\ProductCreationEnabledCodeType;
...
class ProductCreationEnabledCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\Trading\Enums\ProductCreationEnabledCodeType', $this->obj);
    }
}
