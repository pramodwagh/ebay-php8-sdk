...
use PWCode\eBaySDK\ReturnManagement\Types\ReturnResponseDueType;
...
class ReturnResponseDueTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\PWCode\eBaySDK\ReturnManagement\Types\ReturnResponseDueType', $this->obj);
    }
