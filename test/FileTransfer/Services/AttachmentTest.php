<?php
namespace PWCode\eBaySDK\Test\FileTransfer\Services;

use PWCode\eBaySDK\FileTransfer\Services\FileTransferService;
use PWCode\eBaySDK\FileTransfer\Types;
...
class AttachmentTest extends \PHPUnit_Framework_TestCase
{
    public function testAttachmentFieldIsSetCorrectlyInRequest()
    {
        ...
        $this->assertEquals(null, $r->fileAttachment);
        $s->uploadFile($r);
        $this->assertInstanceOf('\PWCode\eBaySDK\FileTransfer\Types\FileAttachment', $r->fileAttachment);
        $this->assertInstanceOf('\PWCode\eBaySDK\FileTransfer\Types\Data', $r->fileAttachment->Data);
        $this->assertInstanceOf('\PWCode\eBaySDK\FileTransfer\Types\XopInclude', $r->fileAttachment->Data->xopInclude);
