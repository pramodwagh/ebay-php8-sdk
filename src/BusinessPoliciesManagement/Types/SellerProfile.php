 ...
 * @property \PWCode\eBaySDK\BusinessPoliciesManagement\Enums\ProfileType $profileType
 * @property integer $profileVersion
 * @property string $profileDesc
 * @property \DateTime $deletedDate
 * @property integer $siteId
 * @property \PWCode\eBaySDK\BusinessPoliciesManagement\Types\CategoryGroups $categoryGroups
 */
class SellerProfile extends \PWCode\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'categoryGroups' => [
            'type' => 'PWCode\eBaySDK\BusinessPoliciesManagement\Types\CategoryGroups',
            'repeatable' => false,
            'attribute' => false,
