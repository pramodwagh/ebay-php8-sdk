 ...
 * @property \PWCode\eBaySDK\BusinessPoliciesManagement\Types\ShippingProfileDiscountInfo $shippingProfileDiscountInfo
 * @property \PWCode\eBaySDK\BusinessPoliciesManagement\Types\FreightShipping $freightShipping
 * @property string[] $shipToLocations
 * @property \PWCode\eBaySDK\BusinessPoliciesManagement\Types\ShippingPolicyInfoService[] $domesticShippingPolicyInfoService
 * @property \PWCode\eBaySDK\BusinessPoliciesManagement\Types\ShippingPolicyInfoService[] $intlShippingPolicyInfoService
 * @property \PWCode\eBaySDK\BusinessPoliciesManagement\Types\Insurance $insurance
 * @property string $intlRateTable
 * @property string $domesticRateTable
 * @property \PWCode\eBaySDK\BusinessPoliciesManagement\Types\Amount $packagingHandlingCosts
 * @property \PWCode\eBaySDK\BusinessPoliciesManagement\Types\Amount $internationalPackagingHandlingCosts
 * @property \PWCode\eBaySDK\BusinessPoliciesManagement\Enums\IsoCurrencyCode $shippingPolicyCurrency
 * @property boolean $GlobalShipping
 * @property boolean $EligibleForPickupDropOff
 */
class ShippingPolicyInfo extends \PWCode\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'shippingProfileDiscountInfo' => [
            'type' => 'PWCode\eBaySDK\BusinessPoliciesManagement\Types\ShippingProfileDiscountInfo',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'shippingProfileDiscountInfo'
        ],
        'freightShipping' => [
            'type' => 'PWCode\eBaySDK\BusinessPoliciesManagement\Types\FreightShipping',
            'repeatable' => false,
            'attribute' => false,
        ...
        'domesticShippingPolicyInfoService' => [
            'type' => 'PWCode\eBaySDK\BusinessPoliciesManagement\Types\ShippingPolicyInfoService',
            'repeatable' => true,
            'attribute' => false,
        ...
        'insurance' => [
            'type' => 'PWCode\eBaySDK\BusinessPoliciesManagement\Types\Insurance',
            'repeatable' => false,
            'attribute' => false,
