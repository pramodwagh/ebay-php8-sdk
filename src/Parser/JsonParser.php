...
{
    /**
     * @param mixed A PHP object derived from PWCode\eBaySDK\Types\BaseType
    ...
    private static function assignProperties(\PWCode\eBaySDK\Types\BaseType $object, array $properties)
    {
