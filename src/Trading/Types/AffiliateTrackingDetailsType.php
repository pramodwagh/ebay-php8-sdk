 ...
 * @property \PWCode\eBaySDK\Trading\Enums\ApplicationDeviceTypeCodeType $ApplicationDeviceType
 * @property string $AffiliateUserID
 */
class AffiliateTrackingDetailsType extends \PWCode\eBaySDK\Types\BaseType
{
    /**
