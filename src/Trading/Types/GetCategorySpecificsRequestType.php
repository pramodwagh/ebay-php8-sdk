 ...
 * @property \PWCode\eBaySDK\Trading\Types\CategoryItemSpecificsType[] $CategorySpecific
 * @property boolean $ExcludeRelationships
 * @property boolean $IncludeConfidence
 * @property boolean $CategorySpecificsFileInfo
 */
class GetCategorySpecificsRequestType extends \PWCode\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'CategorySpecific' => [
            'type' => 'PWCode\eBaySDK\Trading\Types\CategoryItemSpecificsType',
            'repeatable' => true,
            'attribute' => false,
