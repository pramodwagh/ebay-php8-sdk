...
/**
 *
 * @property \PWCode\eBaySDK\Trading\Types\ListingDurationReferenceType[] $ListingDuration
 ...
 * @property \PWCode\eBaySDK\Trading\Enums\AdFormatEnabledCodeType $AdFormatEnabled
 ...
 * @property \PWCode\eBaySDK\Trading\Enums\ClassifiedAdPaymentMethodEnabledCodeType $ClassifiedAdPaymentMethodEnabled
 * @property boolean $ClassifiedAdShippingMethodEnabled
 * @property \PWCode\eBaySDK\Trading\Enums\ClassifiedAdBestOfferEnabledCodeType $ClassifiedAdBestOfferEnabled
 ...
 * @property \PWCode\eBaySDK\Trading\Enums\ItemSpecificsEnabledCodeType $ItemSpecificsEnabled
 ...
 * @property \PWCode\eBaySDK\Trading\Enums\INEscrowWorkflowTimelineCodeType $INEscrowWorkflowTimeline
 * @property \PWCode\eBaySDK\Trading\Types\ListingEnhancementDurationReferenceType $GalleryFeaturedDurations
 * @property boolean $PayPalRequired
 * @property \PWCode\eBaySDK\Trading\Enums\AdFormatEnabledCodeType $eBayMotorsProAdFormatEnabled
 ...
 * @property \PWCode\eBaySDK\Trading\Enums\ClassifiedAdBestOfferEnabledCodeType $eBayMotorsProBestOfferEnabled
 * @property boolean $eBayMotorsProAutoAcceptEnabled
 * @property boolean $eBayMotorsProAutoDeclineEnabled
 * @property \PWCode\eBaySDK\Trading\Enums\ClassifiedAdPaymentMethodEnabledCodeType $eBayMotorsProPaymentMethodCheckOutEnabled
 ...
 * @property \PWCode\eBaySDK\Trading\Enums\AdFormatEnabledCodeType $LocalMarketAdFormatEnabled
 ...
 * @property \PWCode\eBaySDK\Trading\Enums\ClassifiedAdBestOfferEnabledCodeType $LocalMarketBestOfferEnabled
 * @property boolean $LocalMarketAutoAcceptEnabled
 * @property boolean $LocalMarketAutoDeclineEnabled
 * @property \PWCode\eBaySDK\Trading\Enums\ClassifiedAdPaymentMethodEnabledCodeType $LocalMarketPaymentMethodCheckOutEnabled
 ...
 * @property \PWCode\eBaySDK\Trading\Enums\GeographicExposureCodeType $SpecialitySubscription
 * @property \PWCode\eBaySDK\Trading\Enums\GeographicExposureCodeType $RegularSubscription
 * @property \PWCode\eBaySDK\Trading\Enums\GeographicExposureCodeType $PremiumSubscription
 * @property \PWCode\eBaySDK\Trading\Enums\GeographicExposureCodeType $NonSubscription
 ...
 * @property \PWCode\eBaySDK\Trading\Types\StoreOwnerExtendedListingDurationsType $StoreOwnerExtendedListingDurations
 * @property boolean $ReturnPolicyEnabled
 * @property boolean $HandlingTimeEnabled
 * @property \PWCode\eBaySDK\Trading\Types\AmountType $MaxFlatShippingCost
 * @property boolean $MaxFlatShippingCostCBTExempt
 * @property \PWCode\eBaySDK\Trading\Types\AmountType $Group1MaxFlatShippingCost
 * @property \PWCode\eBaySDK\Trading\Types\AmountType $Group2MaxFlatShippingCost
 * @property \PWCode\eBaySDK\Trading\Types\AmountType $Group3MaxFlatShippingCost
 * @property \PWCode\eBaySDK\Trading\Enums\BuyerPaymentMethodCodeType[] $PaymentMethod
 * @property boolean $VariationsEnabled
 * @property boolean $FreeGalleryPlusEnabled
 * @property boolean $FreePicturePackEnabled
 * @property \PWCode\eBaySDK\Trading\Enums\ItemCompatibilityEnabledCodeType $ItemCompatibilityEnabled
 * @property integer $MinItemCompatibility
 * @property integer $MaxItemCompatibility
 * @property \PWCode\eBaySDK\Trading\Enums\ConditionEnabledCodeType $ConditionEnabled
 * @property \PWCode\eBaySDK\Trading\Types\ConditionValuesType $ConditionValues
 * @property boolean $ValueCategory
 * @property \PWCode\eBaySDK\Trading\Enums\ProductCreationEnabledCodeType $ProductCreationEnabled
 * @property \PWCode\eBaySDK\Trading\Enums\ProductIdentiferEnabledCodeType $EANEnabled
 * @property \PWCode\eBaySDK\Trading\Enums\ProductIdentiferEnabledCodeType $ISBNEnabled
 * @property \PWCode\eBaySDK\Trading\Enums\ProductIdentiferEnabledCodeType $UPCEnabled
 * @property integer $MaxGranularFitmentCount
 * @property string $CompatibleVehicleType
 * @property \PWCode\eBaySDK\Trading\Enums\PaymentOptionsGroupEnabledCodeType $PaymentOptionsGroup
 * @property \PWCode\eBaySDK\Trading\Enums\ProfileCategoryGroupCodeType $ShippingProfileCategoryGroup
 * @property \PWCode\eBaySDK\Trading\Enums\ProfileCategoryGroupCodeType $PaymentProfileCategoryGroup
 * @property \PWCode\eBaySDK\Trading\Enums\ProfileCategoryGroupCodeType $ReturnPolicyProfileCategoryGroup
 ...
 * @property \PWCode\eBaySDK\Trading\Enums\ProductRequiredEnabledCodeType $ProductRequiredEnabled
 */
class SiteDefaultsType extends \PWCode\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        'ListingDuration' => [
            'type' => 'PWCode\eBaySDK\Trading\Types\ListingDurationReferenceType',
            'repeatable' => true,
            'attribute' => false,
        ...
        'GalleryFeaturedDurations' => [
            'type' => 'PWCode\eBaySDK\Trading\Types\ListingEnhancementDurationReferenceType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'StoreOwnerExtendedListingDurations' => [
            'type' => 'PWCode\eBaySDK\Trading\Types\StoreOwnerExtendedListingDurationsType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'ConditionValues' => [
            'type' => 'PWCode\eBaySDK\Trading\Types\ConditionValuesType',
            'repeatable' => false,
            'attribute' => false,
