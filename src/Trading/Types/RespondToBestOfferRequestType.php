 ...
 * @property \PWCode\eBaySDK\Trading\Enums\BestOfferActionCodeType $Action
 * @property string $SellerResponse
 * @property \PWCode\eBaySDK\Trading\Types\AmountType $CounterOfferPrice
 * @property integer $CounterOfferQuantity
 */
class RespondToBestOfferRequestType extends \PWCode\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
