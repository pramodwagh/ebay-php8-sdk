 ...
 * @property \PWCode\eBaySDK\Trading\Enums\ShippingServiceCodeType $ShippingServiceCode
 * @property \PWCode\eBaySDK\Trading\Enums\ShippingTypeCodeType[] $ServiceType
 ...
 * @property \PWCode\eBaySDK\Trading\Enums\ShippingCarrierCodeType[] $ShippingCarrier
 * @property boolean $CODService
 * @property \PWCode\eBaySDK\Trading\Types\AnnouncementMessageType[] $DeprecationDetails
 * @property integer $MappedToShippingServiceID
 * @property string $CostGroupFlat
 * @property \PWCode\eBaySDK\Trading\Types\ShippingServicePackageDetailsType[] $ShippingServicePackageDetails
 * @property boolean $WeightRequired
 * @property string $DetailVersion
 * @property \DateTime $UpdateTime
 * @property string $ShippingCategory
 */
class ShippingServiceDetailsType extends \PWCode\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'DeprecationDetails' => [
            'type' => 'PWCode\eBaySDK\Trading\Types\AnnouncementMessageType',
            'repeatable' => true,
            'attribute' => false,
        ...
        'ShippingServicePackageDetails' => [
            'type' => 'PWCode\eBaySDK\Trading\Types\ShippingServicePackageDetailsType',
            'repeatable' => true,
            'attribute' => false,
