 ...
 * @property \PWCode\eBaySDK\Trading\Enums\MessageStatusTypeCodeType $Status
 * @property boolean $IncludeMemberMessages
 * @property \DateTime $StartCreationTime
 * @property \DateTime $EndCreationTime
 */
class GetAdFormatLeadsRequestType extends \PWCode\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
