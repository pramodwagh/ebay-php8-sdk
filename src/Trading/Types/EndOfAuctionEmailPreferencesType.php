 ...
 * @property \PWCode\eBaySDK\Trading\Enums\EndOfAuctionLogoTypeCodeType $LogoType
 * @property boolean $EmailCustomized
 * @property boolean $TextCustomized
 * @property boolean $LogoCustomized
 */
class EndOfAuctionEmailPreferencesType extends \PWCode\eBaySDK\Types\BaseType
{
    /**
