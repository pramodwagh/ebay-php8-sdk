 ...
 * @property \PWCode\eBaySDK\Trading\Types\AmountType $TotalWinningCost
 * @property integer $WonCount
 * @property \PWCode\eBaySDK\Trading\Types\AmountType $TotalWonCost
 * @property integer $WonDurationInDays
 * @property integer $BestOfferCount
 */
class BuyingSummaryType extends \PWCode\eBaySDK\Types\BaseType
{
    /**
