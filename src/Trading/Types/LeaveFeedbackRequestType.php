 ...
 * @property \PWCode\eBaySDK\Trading\Enums\CommentTypeCodeType $CommentType
 * @property string $TransactionID
 * @property string $TargetUser
 * @property \PWCode\eBaySDK\Trading\Types\ItemRatingDetailArrayType $SellerItemRatingDetailArray
 * @property string $OrderLineItemID
 * @property \PWCode\eBaySDK\Trading\Enums\ItemArrivedWithinEDDCodeType $ItemArrivedWithinEDDType
 * @property boolean $ItemDeliveredWithinEDD
 */
class LeaveFeedbackRequestType extends \PWCode\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'SellerItemRatingDetailArray' => [
            'type' => 'PWCode\eBaySDK\Trading\Types\ItemRatingDetailArrayType',
            'repeatable' => false,
            'attribute' => false,
