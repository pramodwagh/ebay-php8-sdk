 ...
 * @property \PWCode\eBaySDK\Trading\Types\AmountType $Price
 * @property \PWCode\eBaySDK\Trading\Enums\BestOfferStatusCodeType $Status
 * @property integer $Quantity
 * @property string $BuyerMessage
 * @property string $SellerMessage
 * @property \PWCode\eBaySDK\Trading\Enums\BestOfferTypeCodeType $BestOfferCodeType
 * @property string $CallStatus
 */
class BestOfferType extends \PWCode\eBaySDK\Types\BaseType
{
    /**
