 ...
 * @property \PWCode\eBaySDK\Trading\Enums\StringMatchCodeType $MatchType
 * @property boolean $Featured
 */
class GetCharitiesRequestType extends \PWCode\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
