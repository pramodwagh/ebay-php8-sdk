 ...
 */
class TradingBaseService extends \PWCode\eBaySDK\Services\BaseService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \PWCode\eBaySDK\Trading\Services\TradingService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string']
    ...
    protected function callOperationAsync($name, \PWCode\eBaySDK\Types\BaseType $request, $responseClass)
    {
        ...
        if ($this->getConfig('authorization') !== null) {
             ...
             */
            if (!isset($request->RequesterCredentials)) {
                $request->RequesterCredentials = new \PWCode\eBaySDK\Trading\Types\CustomSecurityHeaderType();
            }
