 ...
 * @property \PWCode\eBaySDK\Marketing\Types\Dimension[] $dimensions
 * @property \PWCode\eBaySDK\Marketing\Types\InventoryReference[] $inventoryReferences
 * @property string[] $listingIds
 * @property \PWCode\eBaySDK\Marketing\Types\Bas:MarketplaceIdEnum $marketplaceId
 * @property string[] $metricKeys
 * @property string $reportExpirationDate
 * @property \PWCode\eBaySDK\Marketing\Enums\ReportFormatEnum $reportFormat
 ...
 * @property \PWCode\eBaySDK\Marketing\Enums\TaskStatusEnum $reportTaskStatus
 * @property string $reportTaskStatusMessage
 * @property \PWCode\eBaySDK\Marketing\Enums\ReportTypeEnum $reportType
 */
class ReportTask extends \PWCode\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'dimensions' => [
            'type' => 'PWCode\eBaySDK\Marketing\Types\Dimension',
            'repeatable' => true,
            'attribute' => false,
            'elementName' => 'dimensions'
        ],
        'inventoryReferences' => [
            'type' => 'PWCode\eBaySDK\Marketing\Types\InventoryReference',
            'repeatable' => true,
            'attribute' => false,
        ...
        'marketplaceId' => [
            'type' => 'PWCode\eBaySDK\Marketing\Types\Bas:MarketplaceIdEnum',
            'repeatable' => false,
            'attribute' => false,
