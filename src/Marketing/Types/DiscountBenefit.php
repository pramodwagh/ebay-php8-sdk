...
/**
 *
 * @property \PWCode\eBaySDK\Marketing\Types\Amount $amountOffItem
 * @property \PWCode\eBaySDK\Marketing\Types\Amount $amountOffOrder
 * @property string $percentageOffItem
 * @property string $percentageOffOrder
 */
class DiscountBenefit extends \PWCode\eBaySDK\Types\BaseType
{
    /**
