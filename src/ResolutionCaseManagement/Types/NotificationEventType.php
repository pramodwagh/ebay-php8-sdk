...
/**
 *
 * @property \PWCode\eBaySDK\ResolutionCaseManagement\Enums\NotificationEventNameType $NotificationEventName
 * @property string $RecipientUserID
 * @property string $ExternalUserData
 * @property string $CaseId
 * @property \PWCode\eBaySDK\ResolutionCaseManagement\Enums\CaseType $CaseType
 * @property string $ItemId
 * @property string $TransactionId
 * @property \DateTime $CreationDate
 * @property string $OtherPartyId
 * @property \PWCode\eBaySDK\ResolutionCaseManagement\Enums\CaseUserRoleType $OtherPartyRole
 * @property string $CaseStatus
 * @property string $CaseGlobalId
 */
class NotificationEventType extends \PWCode\eBaySDK\Types\BaseType
{
    /**
