 ...
 * @property \PWCode\eBaySDK\ResolutionCaseManagement\Types\Address $returnAddress
 * @property string $returnMerchandiseAuthorization
 * @property string $additionalReturnInstructions
 */
class OfferRefundUponReturnRequest extends \PWCode\eBaySDK\ResolutionCaseManagement\Types\BaseRequest
{
    /**
