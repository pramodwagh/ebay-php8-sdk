 ...
 * @property \PWCode\eBaySDK\ResolutionCaseManagement\Enums\AppealReasonType $appealReason
 * @property string $comments
 */
class AppealToCustomerSupportRequest extends \PWCode\eBaySDK\ResolutionCaseManagement\Types\BaseRequest
{
    /**
