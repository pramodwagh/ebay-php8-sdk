...
/**
 *
 * @property \PWCode\eBaySDK\Order\Types\ErrorDetailV3[] $errors
 * @property \PWCode\eBaySDK\Order\Types\ErrorDetailV3[] $warnings
 */
class UpdateGuestLineItemShippingAddressRestResponse extends \PWCode\eBaySDK\Order\Types\CheckoutSessionResponse
{
    use StatusCodeTrait;
