 ...
 * @property \PWCode\eBaySDK\Order\Types\PaymentInstrument $paymentInstrument
 ...
 * @property \PWCode\eBaySDK\Order\Enums\PurchaseOrderPaymentStatusEnum $purchaseOrderPaymentStatus
 * @property \PWCode\eBaySDK\Order\Enums\PurchaseOrderStatusEnum $purchaseOrderStatus
 * @property \PWCode\eBaySDK\Order\Types\Amount $refundedAmount
 * @property \PWCode\eBaySDK\Order\Types\ShippingAddress $shippingAddress
 * @property \PWCode\eBaySDK\Order\Types\ShippingFulfillment[] $shippingFulfillments
 * @property \PWCode\eBaySDK\Order\Types\ErrorDetailV3[] $warnings
 */
class PurchaseOrder extends \PWCode\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'paymentInstrument' => [
            'type' => 'PWCode\eBaySDK\Order\Types\PaymentInstrument',
            'repeatable' => false,
            'attribute' => false,
        ...
        'shippingFulfillments' => [
            'type' => 'PWCode\eBaySDK\Order\Types\ShippingFulfillment',
            'repeatable' => true,
            'attribute' => false,
