...
/**
 *
 * @property \PWCode\eBaySDK\ReturnManagement\Enums\NotificationEventNameType $NotificationEventName
 * @property string $RecipientUserID
 * @property string $ExternalUserData
 * @property string $ReturnId
 * @property \DateTime $CreationDate
 * @property string $OtherPartyId
 * @property \PWCode\eBaySDK\ReturnManagement\Enums\ReturnUserRoleType $OtherPartyRole
