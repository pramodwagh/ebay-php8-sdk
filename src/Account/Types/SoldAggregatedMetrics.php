...
/**
 *
 * @property \PWCode\eBaySDK\Account\Types\Amount $maxSoldInventoryValue
 * @property integer $maxSoldQuantity
 * @property \PWCode\eBaySDK\Account\Types\Amount $minSoldInventoryValue
 * @property integer $minSoldQuantity
 * @property \PWCode\eBaySDK\Account\Types\TimeDuration $period
 */
class SoldAggregatedMetrics extends \PWCode\eBaySDK\Types\BaseType
{
    /**
