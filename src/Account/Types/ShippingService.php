...
/**
 *
 * @property \PWCode\eBaySDK\Account\Types\Amount $additionalShippingCost
 * @property boolean $buyerResponsibleForPickup
 * @property boolean $buyerResponsibleForShipping
 * @property \PWCode\eBaySDK\Account\Types\Amount $cashOnDeliveryFee
 * @property boolean $freeShipping
 * @property string $shippingCarrierCode
 * @property \PWCode\eBaySDK\Account\Types\Amount $shippingCost
 * @property string $shippingServiceCode
 * @property \PWCode\eBaySDK\Account\Types\RegionSet $shipToLocations
 * @property integer $sortOrder
 * @property \PWCode\eBaySDK\Account\Types\Amount $surcharge
 */
class ShippingService extends \PWCode\eBaySDK\Types\BaseType
{
    /**
