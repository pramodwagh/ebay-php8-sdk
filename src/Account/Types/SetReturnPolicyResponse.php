 ...
 * @property \PWCode\eBaySDK\Account\Enums\RefundMethodEnum $refundMethod
 * @property string $restockingFeePercentage
 * @property string $returnInstructions
 * @property \PWCode\eBaySDK\Account\Enums\ReturnMethodEnum $returnMethod
 * @property \PWCode\eBaySDK\Account\Types\TimeDuration $returnPeriod
 * @property string $returnPolicyId
 * @property boolean $returnsAccepted
 * @property \PWCode\eBaySDK\Account\Enums\ReturnShippingCostPayerEnum $returnShippingCostPayer
 * @property \PWCode\eBaySDK\Account\Types\ErrorDetailV3[] $warnings
 */
class SetReturnPolicyResponse extends \PWCode\eBaySDK\Types\BaseType
{
    /**
