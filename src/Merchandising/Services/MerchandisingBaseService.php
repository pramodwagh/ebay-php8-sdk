 ...
 */
class MerchandisingBaseService extends \PWCode\eBaySDK\Services\BaseService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \PWCode\eBaySDK\Merchandising\Services\MerchandisingService::API_VERSION
            ],
            'globalId' => [
                'valid' => ['string']
            ]
