...
use PWCode\eBaySDK\Credentials\CredentialsInterface;
...
function applyCredentials($value, array &$configuration)
{
    if (is_callable($value)) {
        ...
        throw new \InvalidArgumentException(
            ...
            . 'PWCode\eBaySDK\Credentials\CredentialsInterface, an associative '
 ...
 *
 * @return \PWCode\eBaySDK\HttpHandler
 */
...
{
    if (\PWCode\eBaySDK\Sdk::$STRICT_PROPERTY_TYPES) {
        return true;
    }
