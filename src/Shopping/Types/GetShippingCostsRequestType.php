 ...
 * @property \PWCode\eBaySDK\Shopping\Enums\CountryCodeType $DestinationCountryCode
 * @property boolean $IncludeDetails
 */
class GetShippingCostsRequestType extends \PWCode\eBaySDK\Shopping\Types\AbstractRequestType
{
    /**
