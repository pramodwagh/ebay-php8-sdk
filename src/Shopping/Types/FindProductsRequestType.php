 ...
 * @property \PWCode\eBaySDK\Shopping\Enums\ProductSortCodeType $ProductSort
 * @property \PWCode\eBaySDK\Shopping\Enums\SortOrderCodeType $SortOrder
 * @property integer $MaxEntries
 * @property integer $PageNumber
 * @property string $CategoryID
 * @property boolean $HideDuplicateItems
 */
class FindProductsRequestType extends \PWCode\eBaySDK\Shopping\Types\AbstractRequestType
{
    /**
