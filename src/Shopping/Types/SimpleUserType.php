 ...
 * @property \PWCode\eBaySDK\Shopping\Enums\FeedbackRatingStarCodeType $FeedbackRatingStar
 * @property integer $FeedbackScore
 * @property boolean $UserAnonymized
 * @property boolean $NewUser
 * @property \DateTime $RegistrationDate
 * @property \PWCode\eBaySDK\Shopping\Enums\SiteCodeType $RegistrationSite
 * @property \PWCode\eBaySDK\Shopping\Enums\UserStatusCodeType $Status
 * @property \PWCode\eBaySDK\Shopping\Enums\SellerBusinessCodeType $SellerBusinessType
 ...
 * @property \PWCode\eBaySDK\Shopping\Enums\SellerLevelCodeType $SellerLevel
 * @property boolean $TopRatedSeller
 */
class SimpleUserType extends \PWCode\eBaySDK\Types\BaseType
{
    /**
