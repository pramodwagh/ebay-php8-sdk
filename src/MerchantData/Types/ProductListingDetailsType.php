 ...
 * @property string $UPC
 * @property string $EAN
 * @property \PWCode\eBaySDK\MerchantData\Types\BrandMPNType $BrandMPN
 * @property \PWCode\eBaySDK\MerchantData\Types\TicketListingDetailsType $TicketListingDetails
 * @property boolean $UseFirstProduct
 * @property boolean $IncludeeBayProductDetails
 */
class ProductListingDetailsType extends \PWCode\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'BrandMPN' => [
            'type' => 'PWCode\eBaySDK\MerchantData\Types\BrandMPNType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'BrandMPN'
        ],
        'TicketListingDetails' => [
            'type' => 'PWCode\eBaySDK\MerchantData\Types\TicketListingDetailsType',
            'repeatable' => false,
            'attribute' => false,
