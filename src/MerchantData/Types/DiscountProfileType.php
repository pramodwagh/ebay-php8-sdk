 ...
 * @property \PWCode\eBaySDK\MerchantData\Types\AmountType $EachAdditionalAmount
 * @property \PWCode\eBaySDK\MerchantData\Types\AmountType $EachAdditionalAmountOff
 * @property double $EachAdditionalPercentOff
 * @property \PWCode\eBaySDK\MerchantData\Types\MeasureType $WeightOff
 * @property string $MappedDiscountProfileID
 */
class DiscountProfileType extends \PWCode\eBaySDK\Types\BaseType
{
    /**
