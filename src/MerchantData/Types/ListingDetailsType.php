 ...
 * @property \PWCode\eBaySDK\MerchantData\Types\AmountType $ConvertedBuyItNowPrice
 * @property \PWCode\eBaySDK\MerchantData\Types\AmountType $ConvertedStartPrice
 * @property \PWCode\eBaySDK\MerchantData\Types\AmountType $ConvertedReservePrice
 ...
 * @property \PWCode\eBaySDK\MerchantData\Types\AmountType $MinimumBestOfferPrice
 * @property string $LocalListingDistance
 * @property string $TCROriginalItemID
 * @property string $ViewItemURLForNaturalSearch
 * @property \PWCode\eBaySDK\MerchantData\Types\AmountType $BestOfferAutoAcceptPrice
 * @property \PWCode\eBaySDK\MerchantData\Enums\EndReasonCodeType $EndingReason
 */
class ListingDetailsType extends \PWCode\eBaySDK\Types\BaseType
{
    /**
