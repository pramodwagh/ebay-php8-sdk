 ...
 * @property \PWCode\eBaySDK\MerchantData\Enums\CharityAffiliationTypeCodeType $AffiliationType
 * @property \DateTime $LastUsedTime
 */
class CharityAffiliationDetailType extends \PWCode\eBaySDK\Types\BaseType
{
    /**
