...
/**
 *
 * @property \PWCode\eBaySDK\MerchantData\Types\AmountType $ConvertedMaxBid
 * @property \PWCode\eBaySDK\MerchantData\Types\AmountType $MaxBid
 * @property integer $QuantityBid
 * @property integer $QuantityWon
 * @property boolean $Winning
 */
class BiddingDetailsType extends \PWCode\eBaySDK\Types\BaseType
{
    /**
