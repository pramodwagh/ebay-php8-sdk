<?php
namespace PWCode\eBaySDK\Services;

use PWCode\eBaySDK\Parser\XmlParser;
...
abstract class BaseService
{
     ...
     */
    protected function callOperationAsync($name, \PWCode\eBaySDK\Types\BaseType $request, $responseClass)
    {
        $url = $this->getUrl();
     ...
     */
    protected function buildRequestBody(\PWCode\eBaySDK\Types\BaseType $request)
    {
     ...
     */
    private function buildXopDocument(\PWCode\eBaySDK\Types\BaseType $request)
    {
        return sprintf(
            '%s%s%s%s%s',
     ...
     */
    protected function buildMultipartFormDataXMLPayload(\PWCode\eBaySDK\Types\BaseType $request)
    {
        return sprintf(
            '%s%s%s',
            '--boundary'.self::CRLF,
