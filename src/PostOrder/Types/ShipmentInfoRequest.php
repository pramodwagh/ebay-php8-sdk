 ...
 * @property \PWCode\eBaySDK\PostOrder\Types\Text $sellerComments
 * @property boolean $shippedWithTracking
 * @property string $shippingCarrierName
 * @property \PWCode\eBaySDK\PostOrder\Types\DateTime $shippingDate
 * @property string $trackingNumber
 */
class ShipmentInfoRequest extends \PWCode\eBaySDK\Types\BaseType
{
    /**
