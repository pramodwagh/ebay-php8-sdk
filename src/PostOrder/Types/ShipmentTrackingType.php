 ...
 * @property \PWCode\eBaySDK\PostOrder\Types\DateTime $actualDeliveryDate
 * @property \PWCode\eBaySDK\PostOrder\Types\DateTime $actualShipDate
 * @property string $carrierEnum
 * @property integer $carrierId
 * @property string $carrierName
 * @property string $carrierUsed
 * @property \PWCode\eBaySDK\PostOrder\Types\DateTime $deliveryDate
 * @property \PWCode\eBaySDK\PostOrder\Enums\TrackingStatusEnum $deliveryStatus
 * @property \PWCode\eBaySDK\PostOrder\Types\ReturnAddressType $destinationAddress
 * @property string $errorCode
 * @property string $labelAvailableUntilDate
 * @property \PWCode\eBaySDK\PostOrder\Types\DateTime $labelDate
 * @property string $labelId
 * @property boolean $labelPrintExpired
 * @property boolean $labelVoidExpired
 * @property boolean $markAsReceived
 * @property \PWCode\eBaySDK\PostOrder\Types\DateTime $maxDeliveryEstimate
 * @property \PWCode\eBaySDK\PostOrder\Types\DateTime $minDeliveryEstimate
 * @property \PWCode\eBaySDK\PostOrder\Types\ReturnAddressType $originAddress
 * @property \PWCode\eBaySDK\PostOrder\Types\DateTime $shipDate
 * @property string $shipmentId
 * @property string $shippedBy
 * @property \PWCode\eBaySDK\PostOrder\Enums\ShippingMethodEnum $shippingMethod
 * @property string $trackingNumber
 */
class ShipmentTrackingType extends \PWCode\eBaySDK\Types\BaseType
{
    /**
