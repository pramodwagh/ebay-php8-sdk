 ...
 * @property \PWCode\eBaySDK\PostOrder\Types\DateTime $appealDate
 * @property string $appealReasonCode
 * @property string $appealStatus
 * @property \PWCode\eBaySDK\PostOrder\Enums\AppealStatusEnum $appealStatusEnum
 * @property boolean $eligibleForAppeal
 */
class AppealDetails extends \PWCode\eBaySDK\Types\BaseType
{
    /**
