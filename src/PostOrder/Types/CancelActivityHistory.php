...
/**
 *
 * @property \PWCode\eBaySDK\PostOrder\Types\DateTime $actionDate
 * @property string $activityParty
 * @property \PWCode\eBaySDK\PostOrder\Enums\CancelActivityTypeEnum $activityType
 * @property string $cancelStateFrom
 * @property string $cancelStateTo
 * @property string $cancelStatetateTo
 */
class CancelActivityHistory extends \PWCode\eBaySDK\Types\BaseType
{
    /**
