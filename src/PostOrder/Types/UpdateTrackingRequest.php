...
/**
 *
 * @property \PWCode\eBaySDK\PostOrder\Enums\ShippingCarrierEnum $newCarrierEnum
 * @property string $newCarrierName
 * @property string $newTrackingNumber
 * @property \PWCode\eBaySDK\PostOrder\Enums\ShippingCarrierEnum $usedCarrierEnum
 * @property string $usedCarrierName
 * @property string $usedTrackingNumber
 */
class UpdateTrackingRequest extends \PWCode\eBaySDK\Types\BaseType
{
    /**
