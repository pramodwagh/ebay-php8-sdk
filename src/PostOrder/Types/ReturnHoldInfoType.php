...
/**
 *
 * @property \PWCode\eBaySDK\PostOrder\Types\DateTime $holdCreationDate
 * @property string $holdReferenceId
 * @property \PWCode\eBaySDK\PostOrder\Types\DateTime $holdReleaseDate
 * @property \PWCode\eBaySDK\PostOrder\Enums\ReturnHoldStatusEnum $holdStatus
 * @property string $holdTransactionId
 */
class ReturnHoldInfoType extends \PWCode\eBaySDK\Types\BaseType
{
    /**
