 ...
 */
class ProductMetadataBaseService extends \PWCode\eBaySDK\Services\BaseService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \PWCode\eBaySDK\ProductMetadata\Services\ProductMetadataService::API_VERSION
            ],
            'globalId' => [
                'valid' => ['string']
            ]
