 ...
 * @property \PWCode\eBaySDK\Fulfillment\Types\Amount $holdAmount
 * @property string $holdReason
 * @property string $holdState
 * @property string $releaseDate
 * @property \PWCode\eBaySDK\Fulfillment\Types\SellerActionsToRelease[] $sellerActionsToRelease
 */
class PaymentHold extends \PWCode\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'sellerActionsToRelease' => [
            'type' => 'PWCode\eBaySDK\Fulfillment\Types\SellerActionsToRelease',
            'repeatable' => true,
            'attribute' => false,
