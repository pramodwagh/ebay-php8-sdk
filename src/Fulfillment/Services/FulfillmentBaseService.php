 ...
 */
class FulfillmentBaseService extends \PWCode\eBaySDK\Services\BaseRestService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \PWCode\eBaySDK\Fulfillment\Services\FulfillmentService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
