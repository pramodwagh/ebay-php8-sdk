...
/**
 *
 * @property \PWCode\eBaySDK\RelatedItemsManagement\Types\RelatedProduct[] $relatedProduct
 * @property string $groupName
 * @property integer $rank
 * @property boolean $singleRelatedSKUPurchaseOnly
 */
class RelatedProductGroup extends \PWCode\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        'relatedProduct' => [
            'type' => 'PWCode\eBaySDK\RelatedItemsManagement\Types\RelatedProduct',
            'repeatable' => true,
            'attribute' => false,
