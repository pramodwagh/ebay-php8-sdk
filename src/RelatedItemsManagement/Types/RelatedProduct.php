 ...
 *
 * @property string $SKU
 * @property \PWCode\eBaySDK\RelatedItemsManagement\Types\Discount $discount
 * @property integer $rank
 * @property string $title
 * @property integer $maxQtyForSinglePrimary
 */
class RelatedProduct extends \PWCode\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'discount' => [
            'type' => 'PWCode\eBaySDK\RelatedItemsManagement\Types\Discount',
            'repeatable' => false,
            'attribute' => false,
