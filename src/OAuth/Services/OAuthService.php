<?php
namespace PWCode\eBaySDK\OAuth\Services;

use PWCode\eBaySDK\ConfigurationResolver;
use PWCode\eBaySDK\Credentials\CredentialsProvider;
use PWCode\eBaySDK\UriResolver;
use \PWCode\eBaySDK as Functions;
...
class OAuthService
{
    ...
    private static $operations = [
        'getUserToken' => [
            ...
            'responseClass' => '\PWCode\eBaySDK\OAuth\Types\GetUserTokenRestResponse',
            'params' => [
            ]
        ],
        'refreshUserToken' => [
            'method' => 'POST',
            'resource' => 'oauth2/token',
            'responseClass' => '\PWCode\eBaySDK\OAuth\Types\RefreshUserTokenRestResponse',
            'params' => [
            ]
        ],
        'getAppToken' => [
            'method' => 'POST',
            'resource' => 'oauth2/token',
            'responseClass' => '\PWCode\eBaySDK\OAuth\Types\GetAppTokenRestResponse',
            'params' => [
            ]
        ]
    ];
    ...
    /**
     * @var \PWCode\eBaySDK\ConfigurationResolver Resolves configuration options.
     */
    private $resolver;

    /**
     * @var \PWCode\eBaySDK\UriResolver Resolves uri parameters.
     */
    private $uriResolver;
    ...
    public static function getConfigDefinitions()
    {
        return [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \PWCode\eBaySDK\OAuth\Services\OAuthService::API_VERSION,
                'required' => true
            ],
            'profile' => [
                'valid' => ['string'],
                'fn'    => 'PWCode\eBaySDK\applyProfile',
            ],
            'credentials' => [
                'valid'   => ['PWCode\eBaySDK\Credentials\CredentialsInterface', 'array', 'callable'],
                'fn'      => 'PWCode\eBaySDK\applyCredentials',
                'default' => [CredentialsProvider::class, 'defaultProvider']
            ],
            'debug' => [
                'valid'   => ['bool', 'array'],
                'fn'      => 'PWCode\eBaySDK\applyDebug',
                'default' => false
            ],
            'httpHandler' => [
                'valid'   => ['callable'],
                'default' => 'PWCode\eBaySDK\defaultHttpHandler'
            ],
            'httpOptions' => [
                'valid'   => ['array'],
                'default' => [
     ...
     *
     * @return \PWCode\eBaySDK\Credentials\CredentialsInterface
     */
    ...
    /**
     * @param \PWCode\eBaySDK\OAuth\Types\GetUserTokenRestRequest $request
     * @return \PWCode\eBaySDK\OAuth\Types\GetUserTokenRestResponse
     */
    public function getUserToken(\PWCode\eBaySDK\OAuth\Types\GetUserTokenRestRequest $request)
    {
     ...
     */
    public function getUserTokenAsync(\PWCode\eBaySDK\OAuth\Types\GetUserTokenRestRequest $request)
    {
        if (!$request) {
            $request = new \PWCode\eBaySDK\OAuth\Types\GetUserTokenRestRequest();
        }
    ...
    /**
     * @param \PWCode\eBaySDK\OAuth\Types\RefreshUserTokenRestRequest $request
     * @return \PWCode\eBaySDK\OAuth\Types\RefreshUserTokenRestResponse
     */
    public function refreshUserToken(\PWCode\eBaySDK\OAuth\Types\RefreshUserTokenRestRequest $request)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function refreshUserTokenAsync(\PWCode\eBaySDK\OAuth\Types\refreshUserTokenRestRequest $request)
    {
        if (!$request) {
            $request = new \PWCode\eBaySDK\OAuth\Types\RefreshUserTokenRestRequest();
        }
        if (!isset($request->grant_type)) {
    ...
    /**
     * @param \PWCode\eBaySDK\OAuth\Types\GetAppTokenRestRequest $request
     * @return \PWCode\eBaySDK\OAuth\Types\GetAppTokenRestResponse
     */
    public function getAppToken(\PWCode\eBaySDK\OAuth\Types\GetAppTokenRestRequest $request = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAppTokenAsync(\PWCode\eBaySDK\OAuth\Types\GetAppTokenRestRequest $request = null)
    {
        if (!$request) {
            $request = new \PWCode\eBaySDK\OAuth\Types\GetAppTokenRestRequest();
        }
        if (!isset($request->grant_type)) {
     ...
     * @param \PWCode\eBaySDK\Types\BaseType $request Request object containing the request information.
     *
     * @return \GuzzleHttp\Promise\PromiseInterface A promise that will be resolved with an object created from the JSON response.
     */
    private function callOperationAsync($name, \PWCode\eBaySDK\Types\BaseType $request = null)
    {
